...
# 2. Міняємо місцями елементи з індексами 1 і 5
people_records[1], people_records[5] = people_records[5], people_records[1]

print("Список після перестановки (1<->5):")
print(people_records)

# 3. Перевірка, що всі з індексами 6, 10, 13 мають age >= 30
indexes_to_check = [6, 10, 13]
check_result = all(people_records[i][2] >= 30 for i in indexes_to_check)


print("\nПеревірка віку для індексів 6, 10, 13:", check_result)
